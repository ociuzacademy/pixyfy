...
function saveAlbumTitle(newTitle, albumId) {
    fetch(`/update_album_title/${albumId}/`, {
        method: 'POST',
        headers: {
...
function saveAlbumDescription(newDescription, albumId) {
    fetch(`/update_album_description/${albumId}/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCsrfToken() // Ensure CSRF token is included
...
function savePageTitle(newTitle, page, albumId) {
    fetch(`/update_page_title/${albumId}/${page}/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCsrfToken() // Ensure CSRF token is included
...
function savePageDescription(newDescription, page, albumId) {
    fetch(`/update_page_description/${albumId}/${page}/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCsrfToken() // Ensure CSRF token is included
